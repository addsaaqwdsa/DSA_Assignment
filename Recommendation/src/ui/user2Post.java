 ...
 * @author LENOVO
 */
public class user2Post extends javax.swing.JFrame {
    ...
    private void postActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_postActionPerformed
        ...
        userTree.addContent(content, "User2",interest);        
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(user2Post.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
